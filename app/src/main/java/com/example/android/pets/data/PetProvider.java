...
public class PetProvider extends ContentProvider {
    ...
    private PetDbHelper fieldPetDbHelper;

    @Override
    public boolean onCreate() {
        // Make sure the variable is a global variable, so it can be referenced from other
        // ContentProvider methods.
        fieldPetDbHelper = new PetDbHelper(getContext());
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] projection,
        ...
        SQLiteDatabase database = fieldPetDbHelper.getReadableDatabase();
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        SQLiteDatabase database = fieldPetDbHelper.getWritableDatabase();
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // Insert the new pet with the given values
//        long update = database.update(PetContract.PetEntry.TABLE_NAME, values, selection, selectionArgs);
        // If the ID is -1, then the insertion failed. Log an error and return null.


//        // DELETED to insert new code (to do visible any updates:
...
//        return database.update(PetContract.PetEntry.TABLE_NAME, values, selection, selectionArgs);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case PETS:
                // DELETED to make visible any deletes:
